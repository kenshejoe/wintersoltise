...
function openSite()
{
	 var ref = window.open('http://www.shawacademy.org', '_blank', 'location=yes');
	    ref.addEventListener('loadstart', function(event) { alert(event.url); });
}

function openMobileApp()
{
	 var ref = window.open('http://www.shawacademy.org/mobile-app/advanced-course-details.php', '_blank', 'location=yes');
	    ref.addEventListener('loadstart', function(event) { alert(event.url); });
}
